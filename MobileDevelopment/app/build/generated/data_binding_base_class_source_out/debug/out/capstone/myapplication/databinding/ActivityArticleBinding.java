...
public final class ActivityArticleBinding implements ViewBinding {
  ...
  private ActivityArticleBinding(@NonNull ConstraintLayout rootView, @NonNull WebView webView) {
  ...
  public static ActivityArticleBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityArticleBinding((ConstraintLayout) rootView, webView);
    }
